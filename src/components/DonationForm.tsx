...
export const DonationForm = () => {
  ...
  return (
    <section className="max-w-4xl mx-auto py-12 px-6">
      ...
      <div className="mb-8">
        <h2 className="text-3xl font-black text-center mb-8 uppercase text-gray-900">Ways to Donate & Support</h2>
         ...
         {/* M-Changa */}
          <div className="bg-gradient-to-br from-coco-green/10 to-coco-green/5 p-6 rounded-2xl border-2 border-coco-green/20 hover:border-coco-green transition">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-black text-lg text-gray-900">M-Changa</h3>
            </div>
          ...
          <div className="bg-gradient-to-br from-medical-purple/10 to-medical-purple/5 p-6 rounded-2xl border-2 border-medical-purple/20 hover:border-medical-purple transition">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-black text-lg text-gray-900">Safaricom M-Pesa</h3>
            </div>
            <div className="space-y-2 text-sm">
          ...
          <div className="bg-gradient-to-br from-coco-blue/10 to-coco-blue/5 p-6 rounded-2xl border-2 border-coco-blue/20 hover:border-coco-blue transition">
            <div className="flex items-center gap-3 mb-4">
              <Building2 className="text-coco-blue" size={28} />
              <h3 className="font-black text-lg text-gray-900">NCBA Bank</h3>
            </div>
            <div className="space-y-2 text-sm">
      ...
      <div className="bg-white p-8 rounded-[2.5rem] shadow-2xl border-t-8 border-medical-purple">
        <h2 className="text-2xl font-black text-center mb-2 uppercase italic text-gray-800">I Have Contributed via M-Pesa</h2>
